...
Exec=/usr/bin/brave-browser --no-sandbox --test-type --disable-dev-shm-usage --start-maximized %u
Icon=/opt/brave.com/brave/product_logo_48.png
StartupNotify=true
Terminal=false
Type=Application
...
Name[zh_CN]=新建隐身窗口
Name[zh_TW]=新增無痕式視窗
Exec=/usr/bin/brave-browser --no-sandbox --test-type --disable-dev-shm-usage --incognito
EOF
sudo rm -rf /usr/share/applications/brave-browser.desktop && sudo mv -f ~/brave-browser.desktop /usr/share/applications
