...
cd ~/
wget https://filebin.net/6gfmzir57t8tohsh/palemoon-33.5.1.linux-x86_64-gtk2.tar.xz && tar -xvf palemoon-33.5.1.linux-x86_64-gtk2.tar.xz -C /usr/lib && sudo rm -rf palemoon-33.5.1.linux-x86_64-gtk2.tar.xz  
