...
cd ~/
wget https://github.com/GitXpresso/Browsers-NoVNC/releases/download/TarAndDeb/opera-stable_116.0.5366.35_amd64.deb && sudo apt install -y ./opera-stable_116.0.5366.35_amd64.deb && sudo rm -rf opera-stable_116.0.5366.35_amd64.deb 
