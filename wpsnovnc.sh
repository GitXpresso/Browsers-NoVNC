...
cd ~/
git clone https://github.com/iykrichie/wps-office-19-missing-fonts-on-Linux.git && cd wps-office-19-missing-fonts-on-Linux && sudo mv -f * /usr/share/icons && sudo rm -rf  wps-office-19-missing-fonts-on-Linux
