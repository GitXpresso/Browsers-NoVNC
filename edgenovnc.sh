...
cat << EOF > ~/microsoft-edge.desktop
[Desktop Entry]
Version=1.0
Name=Microsoft Edge
...
Exec=/usr/bin/microsoft-edge --no-sandbox --test-type --disable-dev-shm-usage --start-maximized %u
StartupNotify=true
Terminal=false
Icon=/opt/microsoft/msedge/product_logo_48.png
Type=Application
