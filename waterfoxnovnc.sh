...
tigervncserver  -SecurityTypes none  --I-KNOW-THIS-IS-INSECURE  -xstartup /workspaces/linux-novnc/waterfox/waterfox -xstartup /usr/bin/openbox -geometry 1366x768 -localhost no :1
websockify -D --web=/usr/share/novnc/  --cert=~/linux-novnc/novnc.pem 6200 localhost:5904
